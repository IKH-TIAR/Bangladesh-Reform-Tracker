    ...
    const fetchReforms = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/proposals/public"
        );
      ...
      <div className="bg-green-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-8">
            Track the progress of important reforms and policy changes in
            Bangladesh
          </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Browse through the latest reform initiatives in Bangladesh. Sign in
            to access detailed information, track progress, and participate in
            discussions.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reforms.map((reform) => (
              <ReformCard key={reform._id} proposal={reform} />
            ))}
          </div>
        )}
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-lg bg-gray-50">
              ...
              <p className="text-gray-700">
                Monitor the implementation of reforms with real-time progress
                tracking and milestone updates.
              </p>
            </div>
            <div className="p-6 rounded-lg bg-gray-50">
              <h3 className="text-xl font-semibold mb-3 text-green-700">
              ...
              <p className="text-gray-700">
                Participate in meaningful discussions about reforms that matter
            ...
            <div className="p-6 rounded-lg bg-gray-50">
              ...
              <p className="text-gray-700">
                Get notified about updates to reforms you're following and new
                policy initiatives.
              </p>
            </div>
          </div>
      ...
      <div className="bg-green-600 text-white py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-4">
            Ready to track reforms in Bangladesh?
          </h2>
          <p className="mb-6">
            Create an account to get full access to all features and reforms.
          </p>
          <Link
            to="/signup"
